          ...
          <div className="bg-[#FFFDF9] rounded-2xl p-6 border border-amber-200 shadow-md text-amber-950 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <ul className="w-full space-y-2.5 text-sm font-medium text-amber-900 flex-1">
              ...
              <li className="flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-700 text-xs font-bold border border-blue-200">
                    🏅
                  </span>
                  <span>4th-8th Prize</span>
                </span>
                <span className="font-bold text-[#D9531E]">
                  ₹100{" "}
            ...
            <div className="space-y-6 text-sm sm:text-base">
              <div>
                <h5 className="font-bold text-amber-950 mb-2 flex items-center gap-1.5">
                  <FiCheckCircle className="text-[#F37420]" /> How to
                  Participate
                </h5>
                <ul className="list-disc pl-5 space-y-1 text-amber-900 font-medium">
                  <li>
                    Log in to your account so your daily progress is synced and
                    saved.
                  </li>
                  <li>
                    Chant at least 1 full Mala (108 repetitions of the mantra)
                    daily on this app.
                  </li>
                  <li>
                    Ensure you check-in and complete your japa before midnight
                    local time to maintain your streak.
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h5 className="font-bold text-amber-950 mb-2 flex items-center gap-1.5">
                  <FiCheckCircle className="text-[#F37420]" /> Streak
                  Requirements
                </h5>
                <ul className="list-disc pl-5 space-y-1 text-amber-900 font-medium">
                  <li>
                    <strong>Year-End Prizes:</strong> Devotees who successfully
                    maintain a perfect, unbroken 365-day streak starting from
                    Jan 1, 2026 (or their enrollment date) are eligible.
                  </li>
                  <li>
                    <strong>Monthly Prizes:</strong> Winners are evaluated at
                    the end of each month based on their continuous streak
                    during that month.
                  </li>
                  <li>
                    In case of multiple perfect streaks, the ranking will be
                    determined by the total lifetime count of chants.
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-50 p-4 rounded-xl border border-amber-200/60 text-xs sm:text-sm text-amber-900 font-medium leading-relaxed">
                <strong>* Disclaimer:</strong> This streak challenge is
                organized to inspire and support devotees in their daily
                sadhana. Prizes are distributed transparently based on verified
                app analytics database records. Devotional sincerity is the
                ultimate reward!
              </div>
            </div>
          </div>
