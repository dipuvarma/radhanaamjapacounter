...
export default function LeaderboardPage() {
  // Mocking sign in state
  const [isSignedIn, setIsSignedIn] = useState(false);

  // Mock data for the podium
  const topDevotees = [
    {
      rank: 2,
      name: "Prakash Chand",
  ...
  const otherDevotees = [
    { rank: 1, name: "Ravi Verma", japa: "565,649" },
    { rank: 2, name: "Mukesh Verma", japa: "65,649" },
    { rank: 3, name: "RishiKesh Yadav", japa: "65,249" },
    { rank: 4, name: "Tathagata Mitra", japa: "55,649" },
    { rank: 5, name: "Dhairya Gothi", japa: "47,990" },
    { rank: 6, name: "Aarav Sharma", japa: "42,300" },
    { rank: 7, name: "Meera Bai", japa: "39,108" },
  ];

  return (
    <main
      className={`relative flex-1 bg-[#fffdf8] min-h-screen ${
        !isSignedIn ? "h-screen overflow-hidden" : ""
      }`}
    >
      {/* Background Content with Blur if not signed in */}
      <div
        className={`${
          !isSignedIn ? "blur-md pointer-events-none select-none" : ""
        ...
        <div className="text-center my-6 sm:my-10">
          ...
          <div className="flex justify-center gap-8 sm:gap-16 mt-8 border-b border-amber-100 pb-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-900">4,586</div>
              <div className="text-xs font-semibold text-amber-700/70 tracking-wider uppercase mt-1">
                Participants
              </div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-900">42,43M+</div>
              <div className="text-xs font-semibold text-amber-700/70 tracking-wider uppercase mt-1">
                Total Japas
              </div>
            </div>
            ...
            {otherDevotees.map((devotee) => (
              ...
              >
                ...
                <div className="col-span-6 sm:col-span-8 flex items-center gap-3 sm:gap-4">
                  <div className="w-10 h-10 rounded-full bg-saffron/20 flex items-center justify-center text-saffron font-bold border border-saffron/30 shrink-0">
      ...
      {!isSignedIn && (
        <div className="absolute inset-0 flex items-start pt-10 justify-center z-50 bg-amber-950/20 backdrop-blur-[2px] -mx-4 sm:-mx-8 rounded-t-3xl sm:rounded-t-none">
          <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-2xl max-w-md w-full mx-4 text-center border border-amber-100 transform transition-all">
            ...
            <h2 className="text-3xl font-bold text-amber-950 mb-3 cinzel-heading">
              Unlock Leaderboard
            </h2>
